    ...
    public function dataProvider(): array
    {
        return [
            'Happy flow' => [
                ...
                "    clubmembers(id: ID @eq, id_not: ID @not, id_in: ID @in, id_not_in: ID @not_in, id_lt: ID @lt, id_lte: ID @lte, id_gt: ID @gt, id_gte: ID @gte): [ClubMembers]! @all(model: \"ClubMembers\") @can(if: \"findAllClubMembers\", model: \"User\")\r\n    clubmembersPaginated(id: ID @eq, id_not: ID @not, id_in: ID @in, id_not_in: ID @not_in, id_lt: ID @lt, id_lte: ID @lte, id_gt: ID @gt, id_gte: ID @gte): [ClubMembers]! @paginate(model: \"ClubMembers\") @can(if: \"paginateClubMembers\", model: \"User\")",
