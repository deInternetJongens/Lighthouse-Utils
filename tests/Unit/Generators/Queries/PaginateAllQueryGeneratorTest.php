    ...
    public function dataProvider(): array
    {
        return [
            ...
            [
                ...
                'expected_query' => "    clubmembers(id: ID @eq, id_not: ID @not, id_in: ID @in, id_not_in: ID @not_in, id_lt: ID @lt, id_lte: ID @lte, id_gt: ID @gt, id_gte: ID @gte): [ClubMember]! @all(model: \"ClubMember\") @can(if: \"findAll\", model: \"ClubMember\")\r\n    clubmembersPaginated(id: ID @eq, id_not: ID @not, id_in: ID @in, id_not_in: ID @not_in, id_lt: ID @lt, id_lte: ID @lte, id_gt: ID @gt, id_gte: ID @gte): [ClubMember]! @paginate(model: \"ClubMember\") @can(if: \"paginate\", model: \"ClubMember\")",
            ],
            ...
            [
                ...
                'expected_query' => "    (id: ID @eq, id_not: ID @not, id_in: ID @in, id_not_in: ID @not_in, id_lt: ID @lt, id_lte: ID @lte, id_gt: ID @gt, id_gte: ID @gte): []! @all(model: \"\") @can(if: \"findAll\", model: \"\")\r\n    Paginated(id: ID @eq, id_not: ID @not, id_in: ID @in, id_not_in: ID @not_in, id_lt: ID @lt, id_lte: ID @lte, id_gt: ID @gt, id_gte: ID @gte): []! @paginate(model: \"\") @can(if: \"paginate\", model: \"\")",
            ],
