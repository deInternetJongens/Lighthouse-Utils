    ...
    public function dataProvider(): array
    {
        return [
            ...
            [
                ...
                'expected_query' => "    clubmembers(id: ID @eq, id_not: ID @not, id_in: ID @in, id_not_in: ID @not_in, id_lt: ID @lt, id_lte: ID @lte, id_gt: ID @gt, id_gte: ID @gte): [ClubMember]! @all(model: \"ClubMember\") @can(if: \"findAllClubMember\", model: \"User\")\r\n    clubmembersPaginated(id: ID @eq, id_not: ID @not, id_in: ID @in, id_not_in: ID @not_in, id_lt: ID @lt, id_lte: ID @lte, id_gt: ID @gt, id_gte: ID @gte): [ClubMember]! @paginate(model: \"ClubMember\") @can(if: \"paginateClubMember\", model: \"User\")",
            ],
